srcdir = /root/php/ext/xm
builddir = /root/php/ext/xm
top_srcdir = /root/php/ext/xm
top_builddir = /root/php/ext/xm
EGREP = /bin/grep -E
SED = /bin/sed
...
RE2C = exit 0;
AWK = nawk
shared_objects_xm = xm.lo xm_application.lo xm_loader.lo xm_request.lo xm_controller.lo xm_router.lo
PHP_PECL_EXTENSION = xm
PHP_MODULES = $(phplibdir)/xm.la
PHP_ZEND_EX =
...
prefix = /usr
phplibdir = /root/php/ext/xm/modules
